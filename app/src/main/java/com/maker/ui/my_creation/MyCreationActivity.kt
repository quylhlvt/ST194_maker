package com.maker.ui.my_creation
...
import com.maker.data.callapi.reponse.LoadingStatus
import com.maker.data.model.BodyPartModel
import com.maker.data.model.ColorModel
import com.maker.data.model.CustomModel
import com.maker.data.repository.ApiRepository
import com.maker.dialog.CreateNameDialog
import com.maker.dialog.DialogExit
import com.maker.ui.customview.CustomviewActivity
import com.maker.ui.customview.CustomviewViewModel
import com.maker.ui.main.MainActivity
import com.maker.ui.permision.PermissionViewModel
import com.maker.ui.view.ViewActivity
import com.maker.utils.CONST
import com.maker.utils.DataHelper
import com.maker.utils.DataHelper.dp
import com.maker.utils.DataHelper.getData
import com.maker.utils.PermissionHelper
...
import com.maker.utils.onClick
import com.maker.utils.onClickCustom
import com.maker.utils.onSingleClick
import com.maker.utils.saveFileToExternalStorage
import com.maker.utils.scanMediaFile
import com.maker.utils.share.telegram.TelegramSharing
import com.maker.utils.share.whatsapp.IdGenerator
import com.maker.utils.share.whatsapp.StickerBook
import com.maker.utils.share.whatsapp.StickerPack
import com.maker.utils.share.whatsapp.WhatsappSharingActivity
import com.maker.utils.show
import com.maker.utils.showDialogNotifiListener
import com.maker.utils.showSystemUI
import com.maker.utils.showToast
import com.maker.utils.toList
import com.maker.R
import com.maker.databinding.ActivityMyCreationBinding
...
//                            arrPathAvatar.remove()
            ...
            btnAvatar.onSingleClick {
                if (!checkAvatar) {
                    ...
                    btnDesign.setTextColor(ContextCompat.getColor(this@MyCreationActivity,R.color.app_color2))
            ...
            btnDesign.onSingleClick {
                if (checkAvatar) {
                    ...
                    btnAvatar.setTextColor(  ContextCompat.getColor(this@MyCreationActivity,R.color.app_color2))
                    rcvDesign.show()
                    rcvAvatar.hide()
                    updateLayoutSticker()
                    hideLongClick()
