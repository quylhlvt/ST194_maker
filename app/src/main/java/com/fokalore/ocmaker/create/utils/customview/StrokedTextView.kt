package com.fokalore.ocmaker.create.utils.customview
...
import com.fokalore.ocmaker.create.utils.DataHelper.dpToPx
...
class StrokedTextView @JvmOverloads constructor(
    ...
    private var strokeColor: Int = "#01579B".toColorInt()  // Màu viền
